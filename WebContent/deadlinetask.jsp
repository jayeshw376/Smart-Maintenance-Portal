	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="Completed.jsp"><span class="fa fa-area-chart"></span> Smart Miantainace<span class="dashboard_text">Maintainance Portal</span></a>
          </div>
    ...
    <tr>
     ...
     <th scope="col">Department</th>
      <th scope="col">Deadline Task</th>
  		...
  		PreparedStatement ps1 = con.prepareStatement("select departname, deadlinedate from roadmain");
