          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <a href="welcomeadmine.html"><i class="fa fa-dashboard"></i> <span> Welcome Admine</span>
                </a>
              </li>
		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class="row">
						...
						<body>    
    <center> <h1></h1> </center>   
    <form  action="ViewComplain" method="post">  
        <div class="container">   
        <table class="table">
					  <thead>
					    <tr>
					...
					PreparedStatement ps7=con.prepareStatement("select * from complain ");
				    ...
				    <td><a href="commentdept.html">Add comment</a></td>
