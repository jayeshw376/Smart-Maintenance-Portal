	          ...
	          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	            <ul class="sidebar-menu">
	              ...
	              <li class="treeview">
	                ...
	                <a href="Welcomedept.html"><i class="fa fa-dashboard"></i> <span> Home </span>
	                </a>
	              </li>
	    ...
	    <form >  
	        ...
	        <table class="table">
						<%
							...
							String name=Test.getDepartment();
							PreparedStatement pstmt=con.prepareStatement("select status from complain where department=?");
